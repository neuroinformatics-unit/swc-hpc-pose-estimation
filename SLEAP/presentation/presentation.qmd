...
```{.bash code-line-numbers="1-3|4-8|9-10"}
...
$ ls
sleap_train.py  slurm_infer_script.sh  slurm_train_script.sh
...
::: {.fragment}
- Open the predictions with the `sleap-label` GUI on your PC/laptop
:::
