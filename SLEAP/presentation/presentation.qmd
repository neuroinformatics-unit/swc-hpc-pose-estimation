...
```{.python filename="run_sleap_training.py" code-line-numbers="1-9|28-42"}
import argparse
...
```{.bash filename="train_script_python.sbatch" code-line-numbers="17-24"}
#!/bin/bash
...
## Submitting array batch jobs {.smaller}

What if we want to run the same script for multiple batch sizes?

This will allow us to see how the batch size affects the training.
...
flowchart LR
    ...
    script -->|"batch_size=1"| GPU1["GPU 1"] --> model1["Model 1"]
